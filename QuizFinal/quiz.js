document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateProgressBar(index) {
    ...
    steps.forEach((step, i) => {
      // The "i" is the index of the array elemnent for the "forEach()" function, because "forEach()" is a for loop of an array."
      if (i <= index % 5) {
  ...
  function endQuiz() {
    ...
    if (score >= Math.ceil(0.5 * questions.length)) {
      // Assuming 50% of total questions, Example we are at question 3 => 0.5 * 3 = 1.5, Now the ceil function turns 1.5 to 1
